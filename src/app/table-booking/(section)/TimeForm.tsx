    ...
    <div className="flex w-full flex-col items-center justify-center gap-3">
      ...
      <Form {...form}>
        ...
        >
                  ...
                  <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
                    <PopoverTrigger asChild>
                      <FormControl>
                        <Button
                          variant={"outline"}
                          className={`h-12 w-full justify-start border-muted bg-transparent text-left font-normal text-[#fff] hover:text-[#fff]`}
                        >
              ...
              <div className="custom-scrollbar grid h-[250px] grid-cols-2 gap-6 overflow-y-scroll md:grid-cols-4 lg:grid-cols-5">
                {generateTimeSlots().map((time) => (
                  <div
                    ...
                    className={cn(
                      "flex h-full w-full cursor-pointer items-center justify-center border-[1px] border-gray-800 py-4 text-[#fff]",
          ...
          <Button
            className="w-fit bg-[#FDB813] px-6 py-6 text-[#000] hover:bg-[#ecb128]"
            disabled={disable}
          >
            Book A Table
          </Button>
